...
const socials = [
  ...
  {
    label: "Twitter / X",
    href: "https://twitter.com/AbbottSolicitor",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16" aria-hidden="true">
  ...
  {
    label: "YouTube",
    href: "https://www.youtube.com/@abbottsolicitors2159",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16" aria-hidden="true">
    ...
    <footer className="bg-[#070810] border-t border-[#C9A84C]/10 pt-16 pb-8 px-4 sm:px-6 lg:px-10">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 mb-14">
            ...
            <div className="flex flex-wrap gap-2.5 mt-6">
              {socials.map(({ label, href, icon }) => (
                <a
                  ...
                  aria-label={label}
                  className="w-9 h-9 border border-[#C9A84C]/20 flex items-center justify-center text-[#8A8A94] hover:border-[#C9A84C]/50 hover:text-[#C9A84C] transition-all duration-200"
                >
                  {icon}
                </a>
              ))}
          ...
          {/* Practice areas */}
          <div>
            <h4 className="text-[#C9A84C] text-[10px] tracking-[0.32em] uppercase mb-5 font-sans">
              Practice Areas
            </h4>
        ...
        <div className="border-t border-[#C9A84C]/10 py-8">
